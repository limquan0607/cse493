...
class LungTumorDatasetV2(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return np.expand_dims(data, axis=0), np.expand_dims(mask, axis=0)
...
def get_dataset(preprocessed_input_dir, aug_pipeline=None, data_type="train"):
    ...
    return LungTumorDatasetV2(data_dir, label_dir, transform=aug_pipeline)
